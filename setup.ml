(* OASIS_START *)
(* DO NOT EDIT (digest: 88d98ef2a54d736b7952ee0356b6d3e4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para "An Async-pipe-based interface with OpenSSL.";
                 OASISText.Para
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ctypes.foreign.threaded", None);
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = Some "async_ssl";
                      lib_findlib_name = Some "bindings";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "async_ssl";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "J\234\186\229\185\223;u\251\246\220D\190~\236|";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
