(* OASIS_START *)
(* DO NOT EDIT (digest: af809e583902586149c372e595c755dc) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ffi"; "Import"; "Ssl"; "Std"; "Version"];
                      lib_pack = true;
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "0\130\021\027\006\213\030\230\201\239\243=8$C\027";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
