(* OASIS_START *)
(* DO NOT EDIT (digest: 4d422b3f28a7640cf6309cf0b056c95c) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [("async_ssl_bindings", ["bindings"], []); ("async_ssl", ["lib"], [])];
     lib_c = [("async_ssl", "lib", [])];
     flags =
       [
          (["oasis_library_async_ssl_ccopt"; "compile"],
            [(OASISExpr.EBool true, S [A "-ccopt"; A "-I${pkg_ctypes}/.."])]);
          (["oasis_library_async_ssl_cclib"; "link"],
            [
               (OASISExpr.EBool true,
                 S [A "-cclib"; A "-lssl"; A "-cclib"; A "-lcrypto"])
            ]);
          (["oasis_library_async_ssl_cclib"; "ocamlmklib"; "c"],
